...
# TODO
# dictionary containing hyperparameter names and list of values we want to try
parameters = {'n_estimators': [100, 1000, 500, 800],
...
with mlflow.start_run(run_name= "RF-Grid-Search-Second-Run") as run:
    # Create predictions of X_test using best model
...
runs = client.search_runs(509953321694366, order_by=["attributes.start_time desc"], max_results=1)
runs[0].data.metrics
